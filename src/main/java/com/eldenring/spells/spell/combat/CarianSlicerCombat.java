...
/**
 * 卡利亚迅剑命中：以施法者朝向为轴的扇形。半径 / 半角 / 击退读 {@link CarianSlicerSpell}。
 */
public final class CarianSlicerCombat {
     ...
     */
    public static final float SLASH_VERTICAL_HALF_HEIGHT_BLOCKS = 1.6f;
    ...
    public static void resolveSlash(
        ...
        float radiusBlocks = CarianSlicerSpell.SLASH_RADIUS_BLOCKS;
        float halfAngleDegrees = CarianSlicerSpell.SLASH_HALF_ANGLE_DEGREES;
        ...
        var damageSource = spell.getDamageSource(slicerEntity, livingOwner);
        ...
        for (LivingEntity target : level.getEntitiesOfClass(LivingEntity.class, searchBox, candidate ->
            ...
            double knockbackStrength = CarianSlicerSpell.SLASH_KNOCKBACK_STRENGTH;
            target.knockback(
                    knockbackStrength,
